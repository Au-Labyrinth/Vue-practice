<template>
  <div class="order-wrap">
      ...
      <div class="order-list-choose">
          ...
          <div class="order-list-option">
              结束时间: <vue-date-picker :value="endDate" :width="'100px'" @on-change="changeEndDate"></vue-date-picker>
          </div>

          <div class="order-list-option">
              关键词: <input type="text" v-model="query" class="order-query">
          </div>
      </div>
      <div class="order-list-table">
          <table>
              <tr>
                  <th v-for="head in tableHeads" :class='{active: head.active}' :key="head.key" @click='changeOrderType(head)'> {{ head.label }} </th>
              </tr>
